...
export default function RepoList({projects,activeFilter,setActiveFilter,onCardClick,loading,error}){
  ...
  if(loading){
    return(
      <div className="repo-list">
        ...
        <p className="repo-list-empty">Loading GitHub repositories...</p>
      </div>
    )
  }
  ...
  if(error){
    return(
      <div className="repo-list">
        ...
        <p className="repo-list-empty">GitHub data could not be loaded right now.</p>
      </div>
    )
  }
  ...
  return(
    <div className="repo-list">
      ...
      <div className="repo-grid">
        ...
        {filtered.length===0?(
          <p className="repo-list-empty">No repositories matched this filter.</p>
        ):null}
      </div>
    </div>
  )
