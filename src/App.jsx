...
import { contactInfo, profileInfo, skills } from "./data"
import { getGithubPortfolioData } from "./services/githubApi"
  ...
  return(
    <div className="app">
      ...
      <div className="app-layout">
        <Sidebar profile={profile} contact={contact} skills={skills}/>
